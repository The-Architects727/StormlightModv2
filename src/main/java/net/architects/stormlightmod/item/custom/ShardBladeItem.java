...
public class ShardBladeItem extends MiningToolItem {
    ...
    public ShardBladeItem(ToolMaterial material, Settings settings) {
        super(material, ModTags.Blocks.SHARDBLADE_MINEABLE, settings);
    }
